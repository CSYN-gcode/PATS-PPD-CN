...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_rapid_molding_dmcms' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_RAPID_MOLDING_DMCMS', '192.168.3.235'),
            'port' => env('DB_PORT_RAPID_MOLDING_DMCMS', '3306'),
            'database' => env('DB_DATABASE_RAPID_MOLDING_DMCMS', 'forge'),
            'username' => env('DB_USERNAME_RAPID_MOLDING_DMCMS', 'forge'),
            'password' => env('DB_PASSWORD_RAPID_MOLDING_DMCMS', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql_rapid_sanda_dmcms' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_RAPID_SANDA_DMCMS', '192.168.3.235'),
            'port' => env('DB_PORT_RAPID_SANDA_DMCMS', '3306'),
            'database' => env('DB_DATABASE_RAPID_SANDA_DMCMS', 'forge'),
            'username' => env('DB_USERNAME_RAPID_SANDA_DMCMS', 'forge'),
            'password' => env('DB_PASSWORD_RAPID_SANDA_DMCMS', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
